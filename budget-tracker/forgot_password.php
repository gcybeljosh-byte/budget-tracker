    ...
    <div class="row justify-content-center">
        <div class="col-md-7 col-lg-6">
            <div class="text-center mb-4">
                ...
                <h2 class="h3 fw-bold brand-text">Password Recovery</h2>
                <p class="text-secondary small">Follow the steps below to reset your password.</p>
            </div>
            ...
            <div class="auth-card mx-auto">
                ...
                <?php if ($step == 1): ?>
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-bold shadow-sm" style="background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%); border: none;">
                ...
                <?php elseif ($step == 2): ?>
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-bold shadow-sm" style="background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%); border: none;">
                            Verify Answer <i class="fas fa-shield-check ms-2"></i>
                        </button>
                    </form>
                <?php elseif ($step == 3): ?>
                    <!-- Step 3: New Password -->
                ...
                <?php elseif ($step == 4): ?>
                    ...
                    <div class="text-center py-4">
                        ...
                        <a href="login.php" class="btn btn-primary px-5 py-3 rounded-pill fw-bold shadow-sm" style="background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%); border: none;">
                            Proceed to Login
                        </a>
                    </div>
                <?php endif; ?>
