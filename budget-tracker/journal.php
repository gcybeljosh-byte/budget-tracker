    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4 py-4">
            ...
            <div class="row align-items-center mb-4">
                <div class="col">
                    <h1 class="h3 fw-bold mb-0">Financial Journal</h1>
                    <p class="text-muted small mb-0">Your AI-assisted daily financial reflections and insights.</p>
                </div>
                <div class="col-auto d-flex gap-2 align-items-center">
                    <?php if ($budgetGoal > 0): ?>
                        <div class="bg-white rounded-pill px-3 py-1 shadow-sm border me-2 d-flex align-items-center" role="button" data-bs-toggle="modal" data-bs-target="#budgetGoalModal">
                    ...
                    <button class="btn btn-primary rounded-circle shadow-sm p-0 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;" data-bs-toggle="modal" data-bs-target="#addJournalModal">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden hover-lift transition-all">
                                    ...
                                    <div class="card-body px-4 pt-3 pb-4">
                                        ...
                                        <p class="card-text text-secondary small" style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden;">
                                                        ...
                                                        <table class="table table-borderless table-striped mb-0 small">
                                                            ...
                                                            <tfoot class="border-top fw-bold bg-light">
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end pe-3"><?php echo number_format($totalCredit, 2); ?></td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
                                                                ...
                                                                if (!empty($lines)) {
                                                                    foreach ($lines as $line) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end"><button type="button" class="btn btn-sm btn-link text-danger p-0" onclick="this.closest('tr').remove()"><i class="fas fa-times"></i></button></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                } else {
                    ...
                    <form action="journal.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><?php echo isset($_SESSION['user_currency']) && $_SESSION['user_currency'] == 'USD' ? '$' : '₱'; ?></span>
