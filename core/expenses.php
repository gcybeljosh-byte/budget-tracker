...
// RBAC Check
if (isset($_SESSION['permissions']) && is_array($_SESSION['permissions']) && isset($_SESSION['permissions']['manage_expenses']) && $_SESSION['permissions']['manage_expenses'] === false && $_SESSION['role'] !== 'superadmin') {
