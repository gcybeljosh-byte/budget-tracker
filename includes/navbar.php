                                                ...
                                                <li class="mb-3 pb-3 border-bottom notification-item">
                                                    <div class="d-flex align-items-start">
                                                        <div class="<?php
                                                                    ...
                                                                    elseif ($notif['type'] === 'low_balance' || $notif['type'] === 'budget_near') echo 'bg-warning-subtle text-warning';
                                                                    elseif ($notif['type'] === 'budget_exceeded') echo 'bg-danger-subtle text-danger';
                                                                    elseif (strpos($notif['type'], 'bill_deadline') !== false) echo 'bg-info-subtle text-info';
                                                            ...
                                                            <i class="fas <?php
                                                                            ...
                                                                            elseif ($notif['type'] === 'low_balance' || $notif['type'] === 'budget_near') echo 'fa-exclamation-triangle';
                                                                            elseif ($notif['type'] === 'budget_exceeded') echo 'fa-skull-crossbones';
                                                                            elseif (strpos($notif['type'], 'bill_deadline') !== false) echo 'fa-calendar-exclamation';
                                                        ...
                                                        <div>
                                                            <h6 class="mb-0 small fw-bold"><?php
                                                                                            ...
                                                                                            elseif ($notif['type'] === 'budget_near') echo 'Budget Alert (90%)';
                                                                                            elseif ($notif['type'] === 'budget_exceeded') echo 'Budget Exceeded!';
